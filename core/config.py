...
# ----------------------------------------------------------------
# NOTE: 아래 함수들은 SpeakNodeConfig에 의존하는 채팅 세션 관리
# 유틸리티입니다. SRP 관점에서 별도 모듈(예: core/chat_session.py)
# 분리가 바람직하나, 순환 참조(config ↔ chat_session)를 유발하므로
# 현 시점에서는 이 위치를 유지합니다.
# Phase 5.2에서 SpeakNodeConfig를 인터페이스 분리 시 함께 리팩토링
# 할 예정입니다.
# ================================================================
